...
export class IconComponent implements AfterViewInit {
  @Input() name: 'home' | 'analyze' | 'menu' | 'add' | 'save' | 'filter' | 'collapseArrow' | 'addUser' | 'show'| 'remove'| 'filterWithe'|'pencil'|'pencilWhite'|'delete'|'upadte'| 'settings' = 'home'; // Nombres de los iconos disponibles
